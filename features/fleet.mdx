...
Fleet gives engineering managers a centralized view of every coding agent running in their organization.
...
into member cards on the Fleet dashboard. When you enroll an agent for a member, Edgee:
...
<Frame>
  <img className="block dark:hidden" src="/images/fleet/fleet-overview-light.png" alt="Fleet dashboard overview" />
  <img className="hidden dark:block" src="/images/fleet/fleet-overview-dark.png" alt="Fleet dashboard overview (dark mode)" />
</Frame>
...
<Steps>
  ...
  <Step title="Enroll a coding agent">
    ...
    <Frame>
      <img className="block dark:hidden" src="/images/fleet/fleet-enroll-light.png" alt="Enrollment dialog with agent selection" />
      <img className="hidden dark:block" src="/images/fleet/fleet-enroll-dark.png" alt="Enrollment dialog with agent selection (dark mode)" />
    </Frame>
  </Step>
...
<Frame>
  <img className="block dark:hidden" src="/images/fleet/fleet-member-card-light.png" alt="Member card with usage stats and mini chart" />
  <img className="hidden dark:block" src="/images/fleet/fleet-member-card-dark.png" alt="Member card with usage stats and mini chart (dark mode)" />
</Frame>
...
<Frame>
  <img className="block dark:hidden" src="/images/fleet/fleet-manage-light.png" alt="Agent management dialog" />
  <img className="hidden dark:block" src="/images/fleet/fleet-manage-dark.png" alt="Agent management dialog (dark mode)" />
</Frame>
