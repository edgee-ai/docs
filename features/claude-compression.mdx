...
You can also enable compression directly in the request body using the `compression_model` field, overriding your API key settings. This is useful for testing or for enabling compression on specific requests without changing your API key configuration.
