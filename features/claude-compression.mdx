...
You can also enable Claude or OpenCode compression directly in the request body, overriding your API key settings. This is useful for testing or for enabling compression on specific requests without changing your API key configuration.

```json
{
  "model": "anthropic/claude-sonnet-4-20250514",
  "messages": [...],
  "enable_claude_compression": true
}
```
...
```json
{
  "model": "anthropic/claude-sonnet-4-20250514",
  "messages": [...],
  "enable_opencode_compression": true
}
```
