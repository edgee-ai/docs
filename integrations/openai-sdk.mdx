...
<Note>
  The compression headers below control **Agentic Token Compression**, which works with all models. For an overview of all available compression engines, see [Token Compression for Agentic Workloads](/features/agentic-compression).
</Note>
...
<Tip>
  You can also enable compression per API key in the [Edgee console](/features/agentic-compression). Headers override console settings for specific requests.
</Tip>
