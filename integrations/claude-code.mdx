...
Route your Claude Code traffic through Edgee to **reduce token costs** with intelligent compression and 
...
<CardGroup cols={2}>
  <Card title="Automatic Cost Reduction" icon="dollar-sign">
    If you are using API billing, you will see a significant reduction in your token costs.
  </Card>

  <Card title="Longer Sessions with the Same Token Budget" icon="chart-line">
    If you are using Claude Pro/Max, you can use Claude Code for longer sessions, with the same token budget.
  </Card>
</CardGroup>
