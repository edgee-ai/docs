...
1. Go to [Edgee Console](https://www.edgee.ai)
...
<CardGroup cols={2}>
  ...
  <Card title="Real-Time Savings Tracking" icon="chart-line">
...
4. Check [Edgee's status page](https://status.edgee.ai)
...
If this fails, your API key may be invalid or expired. Generate a new one from the [Edgee Console](https://www.edgee.ai).
