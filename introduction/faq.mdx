...
<AccordionGroup>
  ...
  <Accordion title="What compression engines does Edgee offer?">
    ...
    **Claude Token Compression (Beta)** provides fully lossless compression of tool call results in Claude workflows. It's optimized for Claude Code and tool-heavy Claude applications — no configuration needed, just enable it per API key.
