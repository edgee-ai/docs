...
<CardGroup cols={2}>
  <Card title="Token Compression for Coding Agents" icon="/images/icons/claude.svg" iconType="duotone" href="/introduction/coding-agents">
    Lossless compression for Claude Code, Codex, and OpenCode. Extend your session duration or cut API costs — no code changes required.
  </Card>
