...
<Steps>
  <Step title="Navigate to API Keys">
    Log in to the [Edgee Console](https://www.edgee.ai) and go to the **API
  ...
  <Step title="Copy and Secure Your Token">
    Copy the token immediately and store it securely. The token will only be
    displayed once and cannot be retrieved later.
  </Step>
</Steps>
...
- Explore [Export Cost Data](/api-reference/console-api-export-logs) to get usage and cost information
- Learn how to [Manage Gateway API Keys](/api-reference/console-api-manage-gateway-api-keys) for your Gateway requests
- Set up [BYOK](/api-reference/console-api-provider-keys) to manage custom provider keys
