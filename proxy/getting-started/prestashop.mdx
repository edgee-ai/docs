...
> You must also configure Edgee in your [project settings](/proxy/getting-started/project-settings).

---

## **Step 1: Install the Edgee PrestaShop Module**

1. Contact the Edgee team at [support@edgee.com](mailto:support@edgee.ai) to request the PrestaShop module.
...
Follow the setup instructions [here](/proxy/getting-started/project-settings).
