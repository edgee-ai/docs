...
<Note>See [Custom Domains](/proxy/getting-started/domains) for detailed instructions on configuring domains with Edgee.</Note>
...
2. Follow the [Edgee Routing Guide](/proxy/getting-started/routing) to complete the configuration.  
